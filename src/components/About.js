      ...
      <div className="container">
        <div className="roww">
          ...
          <div className="resumo_fn_main_title">
            ...
            <p className="desc">
              {`My first experience with web development was on MySpace when I would spend countless hours researching and editing HTML 
              code to make my page stand out from the rest of my friends.`}<br></br> <br></br>{`I've always had an interest in building and creating things 
              whether it's art, music, or programming. I am excited to put my knowledge in web development to good use and make a career out of it.`}
            </p>
          </div>
          {/* /Main Title */}
          {/* About Information */}
          <div className="resumo_fn_about_info">
            ...
            <div className="about_right">
              ...
              <div className="resumo_fn_cv_btn">
                <a href="img/Xevier-Turrubiartes-Resume.pdf" download="Xevier-T-Resume">
                  <span className="icon">
                    <svg
